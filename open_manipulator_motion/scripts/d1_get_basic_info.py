...
if __name__ == "__main__":
    ...
    print "\n\n------------ Info. for the group of '%s'" % group_name
    ...
    #print('============ joint position joint0 {0} join1 {1} joint2 {2} joint3 {3} joint4 {4}'\
    #        .format( round(cur_joint[0],3), round(cur_joint[1],3), round(cur_joint[2],3), round(cur_joint[3],3), round(cur_joint[4],3) ))
