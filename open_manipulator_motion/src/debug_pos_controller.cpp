#include "open_manipulator_motion/debug_pos_controller.h"
#include "open_manipulator_motion/DynamixelDebug.h"
#include <vector>
...
void DebugPositionControl::initPublisher()
{
  ...
  debug_data_pub_ = node_handle_.advertise<open_manipulator_motion::DynamixelDebug>("debug_data",10);
}
...
void DebugPositionControl::debugDataPublish(){
   ...
   open_manipulator_motion::DynamixelDebug debug_data;
